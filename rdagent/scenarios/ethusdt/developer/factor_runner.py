...
from rdagent.app.ethusdt_rd_loop.conf import ETHUSDTFactorPropSetting, ETHUSDT_FACTOR_PROP_SETTING
...
class ETHUSDTFactorRunner(CachedRunner[ETHUSDTFactorExperiment]):
    """
    Reuses the QlibFactorRunner logic but with ETHUSDT experiment types.
    """
    ...
    def develop(self, exp: ETHUSDTFactorExperiment) -> ETHUSDTFactorExperiment:
        ...
        if ETHUSDT_FACTOR_PROP_SETTING.test_end is not None:
            env_to_use.update({"test_end": ETHUSDT_FACTOR_PROP_SETTING.test_end})
