...
BinanceFactorHypothesis = Hypothesis


class BinanceFactorHypothesisGen(FactorHypothesisGen):
    ...
    def prepare_context(self, trace: Trace) -> Tuple[dict, bool]:
        ...
        context_dict = {
            ...
            "hypothesis_output_format": T("scenarios.binance.prompts:factor_hypothesis_output_format").r(),
            "hypothesis_specification": T("scenarios.binance.prompts:factor_hypothesis_specification").r(),
        }
        return context_dict, True

    def convert_response(self, response: str) -> Hypothesis:
        response_dict = json.loads(response)
        hypothesis = BinanceFactorHypothesis(
...
class BinanceFactorHypothesis2Experiment(FactorHypothesis2Experiment):
    def prepare_context(self, hypothesis: Hypothesis, trace: Trace) -> Tuple[dict | bool]:
        scenario = trace.scen.get_scenario_all_desc()

        experiment_output_format = T("scenarios.binance.prompts:factor_experiment_output_format").r()
    ...
    def convert_response(self, response: str, hypothesis: Hypothesis, trace: Trace) -> FactorExperiment:
        ...
        exp = BinanceFactorExperiment(tasks, hypothesis=hypothesis)
        exp.based_experiments = [BinanceFactorExperiment(sub_tasks=[])] + [
