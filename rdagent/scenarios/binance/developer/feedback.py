...
class BinanceFactorExperiment2Feedback(Experiment2Feedback):
    def generate_feedback(self, exp: Experiment, trace: Trace) -> HypothesisFeedback:
        """
        Generate feedback for the given experiment and hypothesis.

        Args:
            exp (BinanceFactorExperiment): The experiment to generate feedback for.
            hypothesis (BinanceFactorHypothesis): The hypothesis to generate feedback for.
        ...
        sys_prompt = T("scenarios.binance.prompts:factor_feedback_generation.system").r(
            scenario=self.scen.get_scenario_all_desc()
        )

        # Generate the user prompt
        usr_prompt = T("scenarios.binance.prompts:factor_feedback_generation.user").r(
