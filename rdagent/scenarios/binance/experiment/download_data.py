...
SYMBOLS = [
    ...
    "MATICUSDT", "TRXUSDT", "TONUSDT", "FTMUSDT", "AAVEUSDT",
    "CRVUSDT", "SNXUSDT", "GRTUSDT", "FILUSDT", "STXUSDT",
    "IMXUSDT", "ETCUSDT", "BCHUSDT", "SANDUSDT", "ALGOUSDT",
    "EOSUSDT", "ICPUSDT", "FLOWUSDT", "THETAUSDT", "AXSUSDT", 
    ...
    "TIAUSDT", "SUIUSDT", "FETUSDT", "WLDUSDT", "RNDRUSDT",
    "CFXUSDT", "MASKUSDT", "DYDXUSDT", "FLOKIUSDT", "ONDOUSDT",
