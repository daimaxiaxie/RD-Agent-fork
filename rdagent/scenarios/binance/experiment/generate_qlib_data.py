...
def generate_calendar(qlib_dir: Path, freq: str) -> None:
    ...
    if freq == "240min":
        # Take every 4th timestamp (00:00, 04:00, 08:00, 12:00, 16:00, 20:00)
        cal_new = timestamps[::4]
    else:
...
def main():
    ...
    parser.add_argument("--freq", default="60min", choices=["60min", "240min"], help="Output frequency (default: 60min)")
